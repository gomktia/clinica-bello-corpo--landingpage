...
const aulas = [
    {
        title: "Cavitação",
        desc: "Redução de gordura localizada através de ultrassom cavitacional não invasivo.",
        icon: Target,
    },
    {
    ...
    },
    {
        ...
        desc: "Técnicas avançadas para despigmentação segura e eficaz com tecnologia laser.",
        icon: Target,
    },
    {
        title: "Laser",
        desc: "Especialização em tecnologias laser para rejuvenescimento e tratamentos específicos.",
        icon: Sparkles,
    },
    {
        title: "Ultraformer",
    ...
    {
        title: "Luz Pulsada",
        desc: "Tratamentos de fotodepilação, rejuvenescimento e correção de manchas com tecnologia de luz intensa pulsada.",
        icon: Sparkles,
    },
];
