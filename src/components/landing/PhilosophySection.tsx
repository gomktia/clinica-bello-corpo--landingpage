        ...
        <section id="metodo" className="py-16 md:py-24 bg-white relative overflow-hidden">
            <div className="container mx-auto px-6 lg:px-12">
                ...
                <motion.div
                    ...
                    className="max-w-sm mx-auto mb-16 relative group"
                >
                    ...
                    <div className="relative bg-white p-2 rounded-[2.5rem] border border-primary/20 shadow-extra-elegant overflow-hidden">
                        <div className="aspect-[9/16] w-full rounded-[2rem] overflow-hidden bg-secondary relative">
                            <video
                                ...
                                controls
                            >
                                <source src="/video_lp.mp4" type="video/mp4" />
